 ...
 * @file uh_k_list.h
 * @author your name (weizhiyuan@haier.com)
 * @brief
 * @date 2023-02-16
 *
 * @par History:
 ...
 * <tr><td>2023-02-16   <td>1.0     <td>        <td>
 * </table>
 */
#ifndef __UH_K_LIST_H__
#define __UH_K_LIST_H__
...
#define list_for_each_entry(pos, head, member)                                                                     \
    for (pos = list_entry((head)->next, __typeof__(*pos), member), prefetch(pos->member.next); &pos->member != (head); \
         pos = list_entry(pos->member.next, __typeof__(*pos), member), prefetch(pos->member.next))
...
#define list_for_each_entry_continue(pos, head, member)                                                                \
    for (pos = list_entry(pos->member.next, __typeof__(*pos), member), prefetch(pos->member.next); &pos->member != (head); \
         pos = list_entry(pos->member.next, __typeof__(*pos), member), prefetch(pos->member.next))
